...
When using the advanced text search, we recommend surrounding the query text/commands in double quotes, or in ProcessWire 3.0.182 or newer, the [selectorValueAdvanced() sanitizer method](../../api-full/wire/core/Sanitizer/method-selectorvalueadvanced.md) will take care of preparing and quoting the $value for you.
