...
ProcessWire comes with a base [Module interface](../../api-full/wire/core/_Module/index.md) for implementing any kind of plugin, as well as a few abstract and base objects for predefined module types that can be extended to create a module of that type. Common examples of predefined module types in ProcessWire include:

- [Fieldtype](../../api-full/wire/core/Fieldtype/index.md) for defining field types.
- [Inputfield](../../api-full/wire/core/Inputfield/index.md) for defining types of form input fields.
- [Process](../../api-full/wire/core/Process/index.md) for creating admin processes/applications.
- [Textformatter](../../api-full/wire/core/Textformatter/index.md) for formatting text.
- [AdminTheme](../../api-full/wire/core/AdminThemeFramework/index.md) for creating themes in the admin.
- [WireMail](../../api-full/wire/core/WireMail/index.md) for modules that send email and extend the *WireMail* class.
- [Tfa](../../api-full/wire/core/Tfa/index.md) for implementing a specific kind of two-factor authentication.
- [ImageSizerEngine](../../api-full/wire/core/ImageSizerEngine/index.md) for modules that extend *ImageSizerEngine* for resizing images.
- [FileCompiler](../../api-full/wire/core/FileCompilerModule/index.md) for modules that extend *FileCompilerModule* for compilation of files.
- [FileValidator](../../api-full/wire/core/FileValidatorModule/index.md) for modules that extend *FileValidatorModule* for validation of files.
