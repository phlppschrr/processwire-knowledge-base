# $pageimageVariations->getInfo($basename, $options = array()): bool|string|array
...
~~~~~
// basic usage
$bool = $pageimageVariations->getInfo($basename);

// usage with all arguments
$bool = $pageimageVariations->getInfo($basename, $options = array());
~~~~~
