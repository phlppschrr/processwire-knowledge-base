# $pageimage->maxHeight($n, array $options = array()): Pageimage
...
~~~~~
// basic usage
$pageimage = $pageimage->maxHeight($n);

// usage with all arguments
$pageimage = $pageimage->maxHeight($n, array $options = array());
~~~~~

## Arguments

- `$n` `int` Maximum height
