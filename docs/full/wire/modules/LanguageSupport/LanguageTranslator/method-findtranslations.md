...
- `$options` (optional) `array` - `getInfo` (bool): Return verbose array of information for each found translation? (default=false) - `limit` (int): Limit to this many results or 0 for no maximum (default=0)
