# ProcessPageSearchLive: other

Source: `wire/modules/Process/ProcessPageSearch/ProcessPageSearchLive.php`

- `@method renderList(array $items, $prefix = 'pw-search', $class = 'list')` renderList(array $items, $prefix = 'pw-search', $class = 'list')
- `@method renderItem(array $item, $prefix = 'pw-search', $class = 'list')` renderItem(array $item, $prefix = 'pw-search', $class = 'list')
