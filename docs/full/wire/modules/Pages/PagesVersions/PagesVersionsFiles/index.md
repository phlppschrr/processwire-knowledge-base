...
- [`copyPageVersionFiles(Page $page, $version)`](method-copypageversionfiles.md) ***************************************************************************** API SUPPORT METHODS FOR FILES BY ENTIRE DIRECTORY
...
- [`copyPageFieldVersionFiles(Page $page, Field $field, $version)`](method-copypagefieldversionfiles.md) ***************************************************************************** API SUPPORT METHODS FOR FILES BY FIELD
...
- [`hookPagefilesManagerPath(HookEvent $event)`](method-hookpagefilesmanagerpath.md) ***************************************************************************** HOOKS
