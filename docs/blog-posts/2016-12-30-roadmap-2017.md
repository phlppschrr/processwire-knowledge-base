...
**Documentation has been another major theme of 2016** with a lot of time investment. ProcessWire's code documentation has been improved by leaps and bounds, and a new [API reference](../api-full/index.md) was introduced that serves as a strong and comprehensive reference of ProcessWire's API.
