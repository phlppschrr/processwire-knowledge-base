...
[Last week](/blog/posts/processwire-3.x-api-reference/) I mentioned we'd be continuing the documentation updates into this week and that's exactly what we did. So rather than writing a lot about it here, I'd encourage you to go [check it out](../api-full/index.md), as that's where all the writing is this week! And actually, it was quite a lot! But I'll give you a summary here.
...
Last week I tried to get the main API variables covered. This week those were wrapped up, and then work on the most important core classes commenced. If you go look at the [ProcessWire 3.x API reference](../api-full/index.md), you'll now see more than 20 of the most used core classes now fully covered. Here's a few examples of what you might find…

- Ever wondered [what the core Wire class does](../api-full/wire/core/Wire/index.md)?
- Ever been curious about [all that you can do with a WireArray](../api-full/wire/core/WireArray/index.md)?
- Not totally clear on [what a NullPage is all about](../api-full/wire/core/NullPage/index.md)?
- Any questions on [what makes a Module a Module](../api-full/wire/core/_Module/index.md)? (there's a lot to see here)
- Ever needed a comprehensive list of methods, properties and constants available for an [Inputfield](../api-full/wire/core/Inputfield/index.md) or [InputfieldWrapper](../api-full/wire/core/InputfieldWrapper/index.md)?
- Ever wondered [what all the various methods in a Fieldtype were for](../api-full/wire/core/Fieldtype/index.md)?
- Interested in [what you can do with WireHttp](../api-full/wire/core/WireHttp/index.md)?
- Curious about some of the [fun tools available in WireArray](../api-full/wire/core/WireArray/index.md#pw-methods-fun-tools)?
