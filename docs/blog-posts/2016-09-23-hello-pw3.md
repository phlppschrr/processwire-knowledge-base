...
There actually were a couple of small additions to 3.x this week as well. The [$config](../api-full/wire/core/Config/index.md) API variable can now be used to set configuration properties via method calls. For instance, these are equivalent:
