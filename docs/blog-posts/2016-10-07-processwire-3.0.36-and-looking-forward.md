...
Our [WireMail](../api-full/wire/core/WireMail/index.md) class now has a new [attachment()](../api-full/wire/core/WireMail/method-attachment.md) method that was added by LostKobrakai via a pull request this week. This method enables you to add file attachments to outgoing emails. Note however that while supported by the core WireMail class, it may not yet be supported by 3rd party WireMail modules. However, eventually we are likely to see support for it in those as well. Read more about the new attachment method in the API reference [here](../api-full/wire/core/WireMail/method-attachment.md).
