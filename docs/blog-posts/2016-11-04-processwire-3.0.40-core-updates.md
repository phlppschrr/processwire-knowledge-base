...
If you want the returned value to be already sanitized, specify the name of a [$sanitizer](../api-full/wire/core/Sanitizer/index.md) as the second argument:
...
Many of you reading this may already be familiar with this type of syntax in a [$page](../api-full/wire/core/Page/index.md) API call:
