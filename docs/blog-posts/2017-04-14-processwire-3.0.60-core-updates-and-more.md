...
Source: https://processwire.com/blog/posts/processwire-3.0.60-core-updates-and-more/
...
14 April 2017 by Ryan Cramer [ 8 Comments](/blog/posts/processwire-3.0.60-core-updates-and-more/#comments)
...
This week we pushed out a new version of our official [ProcessWire API reference](../api-full/index.md). This version makes significant improvements to our on-site documentation, relative to the previous:
...
- [ProCache](/blog/categories/procache/) v3.1.6
- [ProFields Table](/store/pro-fields/table/) v0.1.7
- [ProDevTools API Explorer](/store/pro-dev-tools/api-explorer/) v2.0
...
Not a Pro module, but the [AdminThemeUikit](https://github.com/ryancramerdesign/AdminThemeUikit) module was also updated to version 8 this week. This version updates the Uikit version to beta 20 and fixes some minor Inputfield display issues.

Thanks for reading! Hope that you have a good weekend, and be sure to read the [ProcessWire Weekly](http://weekly.pw) tomorrow as well.
