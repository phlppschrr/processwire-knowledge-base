# $pagesLoader->getFresh($selectorOrPage, $options = array()): Page|NullPage
...
~~~~~
// basic usage
$page = $pagesLoader->getFresh($selectorOrPage);

// usage with all arguments
$page = $pagesLoader->getFresh($selectorOrPage, $options = array());
~~~~~
