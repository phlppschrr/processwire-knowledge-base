# $modulesInfo->getModuleInfoProperty($class, $property, array $options = array()): mixed|null
...
~~~~~
// basic usage
$result = $modulesInfo->getModuleInfoProperty($class, $property);

// usage with all arguments
$result = $modulesInfo->getModuleInfoProperty($class, $property, array $options = array());
~~~~~
