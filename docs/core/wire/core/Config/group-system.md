...
- $wireMail: array Default WireMail module settings. See /wire/config.php $config->wireMail for details.
...
- $statusFiles: array File inclusions for ProcessWire’s runtime statuses/states. @since 3.0.142
