...
Method: [setLocation()](method-setlocation.md)
Method: [setPath()](method-setpath.md)
Method: [setUrl()](method-seturl.md)
Method: [path()](method-path.md)
Method: [paths()](method-paths.md)
Method: [js()](method-js.md)
Method: [jsConfig()](method-jsconfig.md)
Method: [phpVersion()](method-phpversion.md)
Method: [version()](method-version.md)
Method: [installedAfter()](method-installedafter.md)
Method: [installedBefore()](method-installedbefore.md)
Method: [serverProtocol()](method-serverprotocol.md)
Method: [requestUrl()](method-requesturl.md)
Method: [requestPath()](method-requestpath.md)
Method: [requestMethod()](method-requestmethod.md)
Method: [versionUrls()](method-versionurls.md)
Method: [versionUrl()](method-versionurl.md)

Constants:
Const: [debugVerbose](const-debugverbose.md)
Const: [debugDev](const-debugdev.md)
