...
- [`count($selector = '', $options = array())`](method-count.md) ************************************************************************************************************* BASIC PUBLIC PAGES API METHODS
...
- [`emptyTrash(array $options = array())`](method-___emptytrash.md) (hookable) ************************************************************************************************************* ADVANCED PAGES API METHODS (more for internal use)
...
- [`saveReady(Page $page)`](method-___saveready.md) (hookable) ******************************************************************************************************************** COMMON PAGES HOOKS
