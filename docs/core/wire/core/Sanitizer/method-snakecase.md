...
- string $value
- array $options - `allow` (string): Characters to allow or range of characters to allow, for placement in regex (default='a-z0-9'). - `hyphen` (string): Character to use as the hyphen (default='-')
