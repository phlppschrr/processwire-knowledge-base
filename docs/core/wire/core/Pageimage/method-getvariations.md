# $pageimage->getVariations(array $options = array()): Pageimages|array
...
$pageimages = $pageimage->getVariations(array $options = array());
~~~~~
...
- `Pageimages|array` Returns Pageimages array of Pageimage instances. Only returns regular array if provided `$options['info']` is true.
