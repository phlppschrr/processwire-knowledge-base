...
- [2. General](#2-general)
  - [2.1. Files](#2.1-files)
  - [2.2. Lines](#2.2-lines)
  - [2.3. Indentation, Tabs, Spaces](#2.3-indentation-tabs-spaces)
  - [2.4. Keywords and True/False/Null](#2.4-keywords-and-true-false-null)

- [3. Namespaces](#3-namespaces)
  - [3.1. Using Namespaces](#3.1-using-namespaces)

- [4. Classes, Properties, and Methods](#4-classes-properties-and-methods)
  - [4.1. Class and Interface Declarations](#4.1-class-and-interface-declarations)
  - [4.2. Constants](#4.2-constants)
  - [4.3. Extends and Implements](#4.3-extends-and-implements)
  - [4.4. Properties](#4.4-properties)
  - [4.5. Properties and magic methods](#4.5-properties-and-magic-methods)
  - [4.6. Methods](#4.6-methods)
  - [4.7. Method Arguments](#4.7-method-arguments)
  - [4.8. Hookable Methods and Arguments (ProcessWire only)](#4.8-hookable-methods-and-arguments-processwire-only)
  - [4.9. abstract, final, and static](#4.9-abstract-final-and-static)
  - [4.10. Method and Function Calls](#4.10-method-and-function-calls)

- [5. Control Structures](#5-control-structures)
  - [5.1. if, elseif, else](#5.1-if-elseif-else)
  - [5.2. switch, case](#5.2-switch-case)
  - [5.3. while, do while](#5.3-while-do-while)
  - [5.4. for](#5.4-for)
  - [4.5. foreach](#4.5-foreach)
  - [4.6. try, catch](#4.6-try-catch)

- [6. Closures](#6-closures)
  - [6.1. Using Closures](#6.1-using-closures)

- [7. Operators](#7-operators)
  - [7.1. Operators and spacing](#7.1-operators-and-spacing)
  - [7.2. Operators in ProcessWire Selector Strings](#7.2-operators-in-processwire-selector-strings)

- [8. Strings and Quotes](#8-strings-and-quotes)
  - [8.1. Single vs. Double Quotes](#8.1-single-vs-double-quotes)
  - [8.2. Variables in strings](#8.2-variables-in-strings)
  - [8.4. Multi-language Translatable Strings](#8.4-multi-language-translatable-strings)

- [9. Using ProcessWire API Variables](#9-using-processwire-api-variables)
  - [9.1. Accessing API Variables](#9.1-accessing-api-variables)
  - [9.2. Creating API Variables](#9.2-creating-api-variables)

- [10. ProcessWire 3.x](#10-processwire-3.x)
  - [10.1. Dependency Injection](#10.1-dependency-injection)
  - [10.2. ProcessWire 3.x Namespace](#10.2-processwire-3.x-namespace)

- [11. Other](#11-other)
  - [11.1. Procedural functions](#11.1-procedural-functions)
  - [11.2. define()](#11.2-define)
  - [11.3. PHPDoc Style Recommendations](#11.3-phpdoc-style-recommendations)
