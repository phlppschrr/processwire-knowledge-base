...
- [Comment descriptions](#comment-descriptions)
  - [Comment notes](#comment-notes)

- [Translation rules](#translation-rules)
  - [Translation function calls must be on one line and in one pair of quotes](#translation-function-calls-must-be-on-one-line-and-in-one-pair-of-quotes)
  - [There may only be one translation function call per line](#there-may-only-be-one-translation-function-call-per-line)
  - [Empty strings](#empty-strings)

- [Best practices](#best-practices)
- [Technical details](#technical-details)
  - [Using Textdomains](#using-textdomains)
