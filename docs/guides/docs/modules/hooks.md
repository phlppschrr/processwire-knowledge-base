...
- [Defining Hooks](#defining-hooks)
  - [Do I want my hook to run before or after the method I am hooking? (Or, does it matter?)](#do-i-want-my-hook-to-run-before-or-after-the-method-i-am-hooking-or-does-it-matter)
  - [Do I want my hook to apply to all instances of a class, or just one?](#do-i-want-my-hook-to-apply-to-all-instances-of-a-class-or-just-one)
  - [Where should I define my hook?](#where-should-i-define-my-hook)
  - [How can my hook read (or modify) the arguments sent to the hooked method?](#how-can-my-hook-read-or-modify-the-arguments-sent-to-the-hooked-method)
  - [How can my hook read (or modify) the return value of the hooked method?](#how-can-my-hook-read-or-modify-the-return-value-of-the-hooked-method)
  - [How can my hook know what object/instance the hook was called on?](#how-can-my-hook-know-what-object-instance-the-hook-was-called-on)
  - [How can my hook replace another method entirely?](#how-can-my-hook-replace-another-method-entirely)
  - [How can I define my own hookable methods?](#how-can-i-define-my-own-hookable-methods)
  - [How can I add a new method via a hook?](#how-can-i-add-a-new-method-via-a-hook)
  - [How can I add a new property via a hook?](#how-can-i-add-a-new-property-via-a-hook)
  - [Shorter hook syntax](#shorter-hook-syntax)

- [URL/path hooks](#url-path-hooks)
- [Conditional hooks](#conditional-hooks)
  - [Defining conditional hooks](#defining-conditional-hooks)
  - [Conditional hooks matching argument type](#conditional-hooks-matching-argument-type)
  - [Conditional hooks matching return value or type](#conditional-hooks-matching-return-value-or-type)

- [More hook features](#more-hook-features)
  - [Hook priority to dictate execution order](#hook-priority-to-dictate-execution-order)
  - [Hooking multiple methods at once](#hooking-multiple-methods-at-once)
