...
- [Automatically loading modules](#automatically-loading-modules)
- [Adding hooks to autoload modules](#adding-hooks-to-autoload-modules)
- [Using an autoload module to add new methods to existing classes](#using-an-autoload-module-to-add-new-methods-to-existing-classes)
