...
- [How do template files work?](#how-do-template-files-work)
- [Basic Usage](#basic-usage)
- [Using other types of fields](#using-other-types-of-fields)
- [Creating markup is your job (most of the time)](#creating-markup-is-your-job-most-of-the-time)
- [Finding and loading other pages from your template file](#finding-and-loading-other-pages-from-your-template-file)
  - [Example: finding all featured pages](#example-finding-all-featured-pages)
  - [Beyond the basics](#beyond-the-basics)
  - [Taking it further](#taking-it-further)
  - [And further...](#and-further)
  - [Full example in context](#full-example-in-context)
...
1. Show 3 pages at the most
2. Only show press releases
3. Show a date
4. Show a summary
5. Sort them newest to oldest
...
[About the API](/docs/start/api/)[API variables](/docs/start/variables/)
