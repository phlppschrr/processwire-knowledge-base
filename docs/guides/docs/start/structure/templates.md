...
- [Scalability and customizability](#scalability-and-customizability)
- [Other Page settings managed by templates](#other-page-settings-managed-by-templates)
...
[Pages](/docs/start/structure/pages/)[Fields](/docs/start/structure/fields/)
