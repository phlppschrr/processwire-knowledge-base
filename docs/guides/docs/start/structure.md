...
](/docs/start/structure/pages/)
Almost everything in ProcessWire is represented by a Page. The term “Page” refers to a webpage, though in ProcessWire it’s also…
Learn more →
- 
[
...
Every Page has a template which defines the type of Page and what fields are present on pages using it. Every template may be…
Learn more →
- 
[
...
](/docs/start/structure/fields/)
Fields in ProcessWire are where the content is actually stored. Any field may be one of many storing content for a Page and its…
Learn more →
- 
[
