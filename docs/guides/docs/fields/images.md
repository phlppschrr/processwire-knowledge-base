...
When your image field is set to contain more than one image, $page->images is a [WireArray](../../../full/wire/core/WireArray/index.md). You may use any of the functions provided by WireArray. For example:
