...
- [Permissions overview](#permissions-overview)
  ...
  - [How do you create a permission?](#how-do-you-create-a-permission)
  - [How are permissions used from the API?](#how-are-permissions-used-from-the-api)

- [Default core permissions](#default-core-permissions)
  - [page-add](#page-add)
  - [page-create](#page-create)
  - [page-delete](#page-delete)
  - [page-edit](#page-edit)
  - [page-edit-front](#page-edit-front)
  - [page-lister](#page-lister)
  - [page-lock](#page-lock)
  - [page-move](#page-move)
  - [page-sort](#page-sort)
...
- [Optional core permissions](#optional-core-permissions)
  - [page-clone](#page-clone)
  - [page-clone-tree](#page-clone-tree)
  - [page-edit-created](#page-edit-created)
  - [page-edit-images](#page-edit-images)
  - [page-edit-trash-created](#page-edit-trash-created)
  - [page-hide](#page-hide)
  - [page-lister-[name]](#page-lister-name)
  - [page-publish](#page-publish)
  - [page-rename](#page-rename)

- [User admin permissions](#user-admin-permissions)
  - [user-admin](#user-admin)
  - [user-admin-all](#user-admin-all)
  - [user-admin-[role]](#user-admin-role)

- [Multi-language page edit permissions](#multi-language-page-edit-permissions)
  - [page-edit-lang-default](#page-edit-lang-default)
  - [page-edit-lang-[name]](#page-edit-lang-name)
  - [page-edit-lang-none](#page-edit-lang-none)
  - [lang-edit](#lang-edit)
