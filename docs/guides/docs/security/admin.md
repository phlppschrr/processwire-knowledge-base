...
- [Preventing dictionary attacks](#preventing-dictionary-attacks)
- [Install an SSL certificate and require https for your admin](#install-an-ssl-certificate-and-require-https-for-your-admin)
- [Keep track of logins](#keep-track-of-logins)
- [Don't install the “forgot password” module unless you need it](#dont-install-the-forgot-password-module-unless-you-need-it)
- [Choose strong passwords](#choose-strong-passwords)
- [Install 2-factor (or multi-factor) authentication](#install-2-factor-or-multi-factor-authentication)
