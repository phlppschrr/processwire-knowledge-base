...
- [How does a template file identify URL segments?](#how-does-a-template-file-identify-url-segments)
- [Best practices](#best-practices)
- [Using $input->urlSegmentStr instead](#using-input-gt-urlsegmentstr-instead)
- [Page numbers and URL segments](#page-numbers-and-url-segments)
