...
Multi page selection fields come as a [PageArray](../../../full/wire/core/PageArray/index.md), which you could output like this:
...
Multi-language text properties have an object value of [LanguagesPageFieldValue](../../../full/wire/modules/LanguageSupport/LanguagesPageFieldValue/index.md), just like multi-language values outside of a Custom Field. When output as a string, they output the text in the current user’s language:
