...
For more details about all the methods that you can call for sanitization, see the [Sanitizer documentation page](../../../full/wire/core/Sanitizer/index.md). We'll also be updating the `$input` documentation page once this feature makes its way to the master branch.
...
Following are just the new methods added in 2.6.14, this is in addition to all the existing [sanitizer methods](../../../full/wire/core/Sanitizer/index.md).
