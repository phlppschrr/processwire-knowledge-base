...
While we're on the subject to images (and files), our [3.x API reference](../../../full/index.md) continues to grow! These new classes have been documented in detail and added to our 3.x API reference this week:

- [Pagefile](../../../full/wire/core/Pagefile/index.md)
- [Pagefiles](../../../full/wire/core/Pagefiles/index.md)
- [Pageimage](../../../full/wire/core/Pageimage/index.md)
- [Pageimages](../../../full/wire/core/Pageimages/index.md)
- [PagefilesManager](../../../full/wire/core/PagefilesManager/index.md)
